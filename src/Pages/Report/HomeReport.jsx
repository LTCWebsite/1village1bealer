...
export default function HomeReport() {
  ...
  function LoadData() {
    ...
    Axios.post(`/api/CountVIPType`, {}, { headers: header }).then((res) => {
      if (res.status === 200) {
          ...
          datasets: [
            {
              label: "Active",
              data: dataActive,
              backgroundColor: ["rgba(255, 223, 143, 1)"],
            ...
            },
            {
              label: "Deactive",
              data: dataDeactive,
              backgroundColor: ["rgba(255, 195, 182, 1)"],
              borderColor: ["rgb(255, 255, 255)"],
              barThickness: 15,
              borderWidth: 1,
            },
    ...
    Axios.post(`/api/CountCateAmount`, {}, { headers: header }).then((res) => {
      if (res.status === 200) {
        let count = res.data?.length;
        setCountCate(count);
          ...
          <Grid xs={8}>
            <div className="wapper-dasborad">
              <div className="wapper-graph">
                ...
                <MyDoughnutChart
                  chartData={loading ? DoughnutData : ChartDoughnut}
                />
              </div>
            </div>
          </Grid>
                          ...
                          <td>
                            {loading ? (
                              ...
                              <span style={{ fontSize: "1rem" }}>
                                {countActive[0]["active"].toLocaleString(
                                  undefined,
                        ...
                        <tr>
                          ...
                          <td>
                            {loading ? (
                              ...
                              <span style={{ fontSize: "1rem" }}>
                                {countActive[0]["deactive"].toLocaleString(
                                  undefined,
                                  { maximumFractionDigits: 2 }
                                )}
                              </span>
              ...
              <div className="wapper-graph">
                ...
                <Grid xs={11} sx={{ marginLeft: "2rem" }}>
                  <MyBarChartHorizontal
                    chartData={loading ? userData : ChartBar}
                  />
                </Grid>
              </div>
            </div>
            ...
            <div className="wapper-dasborad">
              <div className="wapper-graph">
                ...
                <table className="list-type">
                  <tr>
                    <th rowspan="2" className="title-re">
                      ສະຖານະ
                    </th>
                    <th colspan="23" className="title-re2">
                      ປະເພດ VIP
                    </th>
                  </tr>
                  <tr>
